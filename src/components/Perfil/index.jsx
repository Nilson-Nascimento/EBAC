...
const Perfil = () => {
    ...
    return (
        <div>
            <h1 className="logo-spin">Desenvolvedor Full Stack Java</h1> {/* Título principal exibido em um elemento h1. Em React */}
            <h2 >{usuario.name}</h2> {/* Nome do usuário exibido em um elemento h2. */}
            <img className="logo-spin" src={usuario.avatarGithub} /> {/* Imagem do avatar do GitHub. Em src não é necessário as "" duplas*/ }
